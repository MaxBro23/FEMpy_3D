...
if __name__ == "__main__":
    ...
    viewer.visualise_constraints_by_cones(scale=0.005)
    # # Add all forces to the 3D Plotter Window
    viewer.visualise_forces_by_arrows(scale=0.03)

    # # Open the GUI application
    plotter.show_axes()
    plotter.title = "Mesh created by LS-PrePost"
