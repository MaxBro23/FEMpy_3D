...
def test_build_structure():
    ...
    s.add_linear_hexahedral(e_mod, poisson_ratio, density, 0, 1, 2, 3, 4, 5, 6, 7)
    s.add_linear_hexahedral(e_mod, poisson_ratio, density, 1, 8, 9, 2, 5, 11, 10, 6)
    ...
    assert(np.isclose(np.max(displacements_x), 0.04413826782163021, rtol=1e-05))
    assert(np.isclose(np.min(displacements_x), 0.0, rtol=1e-05))
    assert(np.isclose(np.max(displacements_y), 0.02594153477639796, rtol=1e-05))
    assert(np.isclose(np.min(displacements_y), 0.0, rtol=1e-05))
    assert(np.isclose(np.max(displacements_z), 0.005000810061179577, rtol=1e-05))
    assert(np.isclose(np.min(displacements_z), -0.005000810061179507, rtol=1e-05))
    assert(np.isclose(np.max(stress_list), 391.47888418025315, rtol=1e-05))
    assert(np.isclose(np.min(stress_list), 307.4669763302192, rtol=1e-05))
    assert(np.isclose(np.mean(stress_list), 349.4729302552362, rtol=1e-05))
    assert(np.isclose(np.median(stress_list), 349.4729302552362, rtol=1e-05))